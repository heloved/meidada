...
<script>
    ...
    layList.tableList('userList',"{:Url('merchant/get_user_list')}",function () {
        return [
            ...
            {field: 'merchant_name', width:'6%', title: '商户名称'},
            {field: 'account',  width:'6%',title: '账号',},
            {field: 'pwd', title: '密码',align:'center',width:'6%'},
            {field: 'address', title: '地址',align:'center',width:'12%'},
