            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    ...
                    <script type="text/html" id="barDemo">
                        ...
                        <button type="button" class="layui-btn layui-btn-xs" lay-event="see"><i class="layui-icon layui-icon-edit"></i>停用</button>
                        <button type="button" class="layui-btn layui-btn-xs" lay-event="del"><i class="layui-icon layui-icon-edit"></i>删除</button>
                    </script>
                </div>
            </div>
        </div>
...
<script>
    ...
    layList.tableList('userList',"{:Url('merchant.merchant/get_user_list')}",function () {
        return [
            {type:'checkbox'},
            {field: 'id', title: '编号', width:'5%',event:'id'},
            {field: 'merchant_name', width:'14%', title: '商户名称'},
            {field: 'account',  width:'10%',title: '账号',},
            {field: 'pwd', title: '密码',align:'center',width:'15%'},
            {field: 'address', title: '地址',align:'center',width:'25%'},
            {field: 'add_time', title: '入驻时间',align:'center',width:'15%'},
