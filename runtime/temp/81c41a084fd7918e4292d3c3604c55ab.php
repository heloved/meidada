<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"D:\phpStudy\PHPTutorial\WWW\miniPro/application/admin\view\article\article\index.php";i:1557290368;s:79:"D:\phpStudy\PHPTutorial\WWW\miniPro\application\admin\view\public\container.php";i:1557290368;s:80:"D:\phpStudy\PHPTutorial\WWW\miniPro\application\admin\view\public\frame_head.php";i:1557290368;s:75:"D:\phpStudy\PHPTutorial\WWW\miniPro\application\admin\view\public\style.php";i:1557290368;s:80:"D:\phpStudy\PHPTutorial\WWW\miniPro\application\admin\view\public\inner_page.php";i:1557290368;s:82:"D:\phpStudy\PHPTutorial\WWW\miniPro\application\admin\view\public\frame_footer.php";i:1557290368;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div class="col-sm-12">
        <div class="ibox">
            <div class="ibox-title">
                <button type="button" class="btn btn-w-m btn-primary" onclick="$eb.createModalFrame(this.innerText,'<?php echo Url('create',array('cid'=>$cid)); ?>',{w:1000,h:760})">添加文章</button>
                    ...
                    <div class="m-b m-l">
                        <form action="" class="form-inline">
                            <select name="cid" aria-controls="editable" class="form-control input-sm">
                                ...
                                <option value="<?php echo $vo['id']; ?>" <?php if($where['cid'] == $vo['id']): ?>selected="selected"<?php endif; ?>><?php echo $vo['html']; ?><?php echo $vo['title']; ?></option>
            ...
            <div class="ibox-content">
                <table class="footable table table-striped  table-bordered " data-page-size="20">
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo $vo['catename']; ?></td>
                        ...
                        <td class="text-center">
                            <button class="btn btn-info btn-xs" type="button"  onclick="$eb.createModalFrame('编辑','<?php echo Url('create',array('id'=>$vo['id'],'cid'=>$cid)); ?>',{w:1000,h:760})"><i class="fa fa-paste"></i> 编辑</button>
